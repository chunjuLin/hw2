...
Fs = int(s.readline())  # sampling rate
Ts = 1.0/Fs # sampling interval
t = np.arange(0,100/Fs*10,Ts) # time vector; create Fs samples between 0 and 1.0 sec.
y = np.arange(0,100/Fs*10,Ts) # signal vector; create Fs samples
